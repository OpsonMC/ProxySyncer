...
import dev.agones.models.V1GameServerSpecTemplateSpecRbdSecretRef;
...
public class V1GameServerSpecTemplateSpecRbd {
  ...
  private V1GameServerSpecTemplateSpecRbdSecretRef secretRef;
  ...
  public V1GameServerSpecTemplateSpecRbd fsType(String fsType) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecRbd image(String image) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecRbd keyring(String keyring) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecRbd monitors(List<String> monitors) {
    
    this.monitors = monitors;
    return this;
  }

  public V1GameServerSpecTemplateSpecRbd addMonitorsItem(String monitorsItem) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecRbd pool(String pool) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecRbd readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecRbd secretRef(V1GameServerSpecTemplateSpecRbdSecretRef secretRef) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecRbdSecretRef getSecretRef() {
    return secretRef;
  }


  public void setSecretRef(V1GameServerSpecTemplateSpecRbdSecretRef secretRef) {
    this.secretRef = secretRef;
  }


  public V1GameServerSpecTemplateSpecRbd user(String user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1GameServerSpecTemplateSpecRbd v1GameServerSpecTemplateSpecRbd = (V1GameServerSpecTemplateSpecRbd) o;
    return Objects.equals(this.fsType, v1GameServerSpecTemplateSpecRbd.fsType) &&
        Objects.equals(this.image, v1GameServerSpecTemplateSpecRbd.image) &&
        Objects.equals(this.keyring, v1GameServerSpecTemplateSpecRbd.keyring) &&
        Objects.equals(this.monitors, v1GameServerSpecTemplateSpecRbd.monitors) &&
        Objects.equals(this.pool, v1GameServerSpecTemplateSpecRbd.pool) &&
        Objects.equals(this.readOnly, v1GameServerSpecTemplateSpecRbd.readOnly) &&
        Objects.equals(this.secretRef, v1GameServerSpecTemplateSpecRbd.secretRef) &&
        Objects.equals(this.user, v1GameServerSpecTemplateSpecRbd.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1GameServerSpecTemplateSpecRbd {\n");
