...
public class V1GameServerSpecTemplateSpecFc {
  ...
  public V1GameServerSpecTemplateSpecFc fsType(String fsType) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecFc lun(Integer lun) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecFc readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecFc targetWWNs(List<String> targetWWNs) {
    
    this.targetWWNs = targetWWNs;
    return this;
  }

  public V1GameServerSpecTemplateSpecFc addTargetWWNsItem(String targetWWNsItem) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecFc wwids(List<String> wwids) {
    
    this.wwids = wwids;
    return this;
  }

  public V1GameServerSpecTemplateSpecFc addWwidsItem(String wwidsItem) {
    if (this.wwids == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1GameServerSpecTemplateSpecFc v1GameServerSpecTemplateSpecFc = (V1GameServerSpecTemplateSpecFc) o;
    return Objects.equals(this.fsType, v1GameServerSpecTemplateSpecFc.fsType) &&
        Objects.equals(this.lun, v1GameServerSpecTemplateSpecFc.lun) &&
        Objects.equals(this.readOnly, v1GameServerSpecTemplateSpecFc.readOnly) &&
        Objects.equals(this.targetWWNs, v1GameServerSpecTemplateSpecFc.targetWWNs) &&
        Objects.equals(this.wwids, v1GameServerSpecTemplateSpecFc.wwids);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1GameServerSpecTemplateSpecFc {\n");
