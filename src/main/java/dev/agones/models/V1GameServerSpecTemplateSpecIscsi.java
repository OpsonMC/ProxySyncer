...
import dev.agones.models.V1GameServerSpecTemplateSpecIscsiSecretRef;
...
public class V1GameServerSpecTemplateSpecIscsi {
  ...
  private V1GameServerSpecTemplateSpecIscsiSecretRef secretRef;
  ...
  public V1GameServerSpecTemplateSpecIscsi chapAuthDiscovery(Boolean chapAuthDiscovery) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsi chapAuthSession(Boolean chapAuthSession) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsi fsType(String fsType) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsi initiatorName(String initiatorName) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsi iqn(String iqn) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsi iscsiInterface(String iscsiInterface) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsi lun(Integer lun) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsi portals(List<String> portals) {
    
    this.portals = portals;
    return this;
  }

  public V1GameServerSpecTemplateSpecIscsi addPortalsItem(String portalsItem) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsi readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsi secretRef(V1GameServerSpecTemplateSpecIscsiSecretRef secretRef) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecIscsiSecretRef getSecretRef() {
    return secretRef;
  }


  public void setSecretRef(V1GameServerSpecTemplateSpecIscsiSecretRef secretRef) {
    this.secretRef = secretRef;
  }


  public V1GameServerSpecTemplateSpecIscsi targetPortal(String targetPortal) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1GameServerSpecTemplateSpecIscsi v1GameServerSpecTemplateSpecIscsi = (V1GameServerSpecTemplateSpecIscsi) o;
    return Objects.equals(this.chapAuthDiscovery, v1GameServerSpecTemplateSpecIscsi.chapAuthDiscovery) &&
        Objects.equals(this.chapAuthSession, v1GameServerSpecTemplateSpecIscsi.chapAuthSession) &&
        Objects.equals(this.fsType, v1GameServerSpecTemplateSpecIscsi.fsType) &&
        Objects.equals(this.initiatorName, v1GameServerSpecTemplateSpecIscsi.initiatorName) &&
        Objects.equals(this.iqn, v1GameServerSpecTemplateSpecIscsi.iqn) &&
        Objects.equals(this.iscsiInterface, v1GameServerSpecTemplateSpecIscsi.iscsiInterface) &&
        Objects.equals(this.lun, v1GameServerSpecTemplateSpecIscsi.lun) &&
        Objects.equals(this.portals, v1GameServerSpecTemplateSpecIscsi.portals) &&
        Objects.equals(this.readOnly, v1GameServerSpecTemplateSpecIscsi.readOnly) &&
        Objects.equals(this.secretRef, v1GameServerSpecTemplateSpecIscsi.secretRef) &&
        Objects.equals(this.targetPortal, v1GameServerSpecTemplateSpecIscsi.targetPortal);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1GameServerSpecTemplateSpecIscsi {\n");
