 ...
 */
@ApiModel(description = "Periodic probe of container service readiness. Container will be removed from service endpoints if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes")
...
public class V1GameServerSpecTemplateSpecReadinessProbe {
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe exec(V1GameServerSpecTemplateSpecLifecyclePostStartExec exec) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe failureThreshold(Integer failureThreshold) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe grpc(V1GameServerSpecTemplateSpecLivenessProbeGrpc grpc) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe httpGet(V1GameServerSpecTemplateSpecLifecyclePostStartHttpGet httpGet) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe initialDelaySeconds(Integer initialDelaySeconds) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe periodSeconds(Integer periodSeconds) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe successThreshold(Integer successThreshold) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe tcpSocket(V1GameServerSpecTemplateSpecLivenessProbeTcpSocket tcpSocket) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe terminationGracePeriodSeconds(Long terminationGracePeriodSeconds) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecReadinessProbe timeoutSeconds(Integer timeoutSeconds) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1GameServerSpecTemplateSpecReadinessProbe v1GameServerSpecTemplateSpecReadinessProbe = (V1GameServerSpecTemplateSpecReadinessProbe) o;
    return Objects.equals(this.exec, v1GameServerSpecTemplateSpecReadinessProbe.exec) &&
        Objects.equals(this.failureThreshold, v1GameServerSpecTemplateSpecReadinessProbe.failureThreshold) &&
        Objects.equals(this.grpc, v1GameServerSpecTemplateSpecReadinessProbe.grpc) &&
        Objects.equals(this.httpGet, v1GameServerSpecTemplateSpecReadinessProbe.httpGet) &&
        Objects.equals(this.initialDelaySeconds, v1GameServerSpecTemplateSpecReadinessProbe.initialDelaySeconds) &&
        Objects.equals(this.periodSeconds, v1GameServerSpecTemplateSpecReadinessProbe.periodSeconds) &&
        Objects.equals(this.successThreshold, v1GameServerSpecTemplateSpecReadinessProbe.successThreshold) &&
        Objects.equals(this.tcpSocket, v1GameServerSpecTemplateSpecReadinessProbe.tcpSocket) &&
        Objects.equals(this.terminationGracePeriodSeconds, v1GameServerSpecTemplateSpecReadinessProbe.terminationGracePeriodSeconds) &&
        Objects.equals(this.timeoutSeconds, v1GameServerSpecTemplateSpecReadinessProbe.timeoutSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1GameServerSpecTemplateSpecReadinessProbe {\n");
