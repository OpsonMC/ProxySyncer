 ...
 */
@ApiModel(description = "The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.")
...
public class V1GameServerSpecTemplateSpecSecurityContext2SeccompProfile {
  ...
  public V1GameServerSpecTemplateSpecSecurityContext2SeccompProfile localhostProfile(String localhostProfile) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecSecurityContext2SeccompProfile type(String type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1GameServerSpecTemplateSpecSecurityContext2SeccompProfile v1GameServerSpecTemplateSpecSecurityContext2SeccompProfile = (V1GameServerSpecTemplateSpecSecurityContext2SeccompProfile) o;
    return Objects.equals(this.localhostProfile, v1GameServerSpecTemplateSpecSecurityContext2SeccompProfile.localhostProfile) &&
        Objects.equals(this.type, v1GameServerSpecTemplateSpecSecurityContext2SeccompProfile.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1GameServerSpecTemplateSpecSecurityContext2SeccompProfile {\n");
