...
public class V1GameServerSpecTemplateSpecScaleIOSecretRef {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;


  public V1GameServerSpecTemplateSpecScaleIOSecretRef name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1GameServerSpecTemplateSpecScaleIOSecretRef v1GameServerSpecTemplateSpecScaleIOSecretRef = (V1GameServerSpecTemplateSpecScaleIOSecretRef) o;
    return Objects.equals(this.name, v1GameServerSpecTemplateSpecScaleIOSecretRef.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1GameServerSpecTemplateSpecScaleIOSecretRef {\n");
