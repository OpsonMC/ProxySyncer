...
import dev.agones.models.V1GameServerSpecTemplateSpecCsiNodePublishSecretRef;
...
public class V1GameServerSpecTemplateSpecCsi {
  ...
  private V1GameServerSpecTemplateSpecCsiNodePublishSecretRef nodePublishSecretRef;
  ...
  public V1GameServerSpecTemplateSpecCsi driver(String driver) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecCsi fsType(String fsType) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecCsi nodePublishSecretRef(V1GameServerSpecTemplateSpecCsiNodePublishSecretRef nodePublishSecretRef) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecCsiNodePublishSecretRef getNodePublishSecretRef() {
    return nodePublishSecretRef;
  }


  public void setNodePublishSecretRef(V1GameServerSpecTemplateSpecCsiNodePublishSecretRef nodePublishSecretRef) {
    this.nodePublishSecretRef = nodePublishSecretRef;
  }


  public V1GameServerSpecTemplateSpecCsi readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1GameServerSpecTemplateSpecCsi volumeAttributes(Map<String, String> volumeAttributes) {
    
    this.volumeAttributes = volumeAttributes;
    return this;
  }

  public V1GameServerSpecTemplateSpecCsi putVolumeAttributesItem(String key, String volumeAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1GameServerSpecTemplateSpecCsi v1GameServerSpecTemplateSpecCsi = (V1GameServerSpecTemplateSpecCsi) o;
    return Objects.equals(this.driver, v1GameServerSpecTemplateSpecCsi.driver) &&
        Objects.equals(this.fsType, v1GameServerSpecTemplateSpecCsi.fsType) &&
        Objects.equals(this.nodePublishSecretRef, v1GameServerSpecTemplateSpecCsi.nodePublishSecretRef) &&
        Objects.equals(this.readOnly, v1GameServerSpecTemplateSpecCsi.readOnly) &&
        Objects.equals(this.volumeAttributes, v1GameServerSpecTemplateSpecCsi.volumeAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1GameServerSpecTemplateSpecCsi {\n");
